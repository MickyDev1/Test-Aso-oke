...
"[project]/app/(main)/cart/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CartPage() {
    ...
    const { cartItems, removeFromCart, updateQuantity, cartTotal } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cart$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    const handleCheckout = async ()=>{
        if (cartItems.length === 0) return;
        const user = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"].currentUser;
        if (!user) {
            router.push("/login");
            return;
        }
...
_s(CartPage, "6xM733W96B7QxpwksjVCkKuCyfA=", false, function() {
    return [
...
//# sourceMappingURL=_f23619bc._.js.map